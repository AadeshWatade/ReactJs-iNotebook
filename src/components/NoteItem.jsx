        ...
        <Dialog
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            <Transition.Child
              ...
              <div className={`inline-block ${props.currentTheme === 'dark' ? 'bg-[#020202] text-white' : 'bg-lightBackground text-black'} w-full border border-primary max-w-lg shadow-primary p-6 my-8 overflow-hidden text-left align-middle transition-all transform shadow-lg rounded-2xl`}>
                <Dialog.Title
                  as="h3"
