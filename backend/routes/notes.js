...
//ROUTE 1 : Get aqll notes using : GET "/api/notes/fetchallnotes". Authentication required
...
//ROUTE 2 : Add notes using : POST "/api/notes/addnote". Authentication required
router.post(
  '/addnote',
  fetchuser,
  [
